...
<head>
    ...
    <link rel="stylesheet" href="css/menuposloginemp.css">
...
<body>
        ...
        <div class="buttons">
            <button type="button" class="btn-cadastrar" onclick="window.location.href = 'pedidoscoleta.php'">Agenda de Coletas<i class="fas fa-arrow-right"></i>
            </button>
            <button type="button" class="btn-sobre" onclick="window.location.href = 'cancelarcoletaemp.php'">Cancelar Coleta<i class="fas fa-arrow-right"></i>
            </button>
            <button type="button" class="btn-cadastrar" onclick="window.location.href = 'concluircoleta.php'">Concluir Coleta<i class="fas fa-arrow-right"></i>
            </button>
            <button class="btn-sobre" onclick="window.location.href = 'minhascoletas.php'">Histórico de Coletas<i class="fas fa-arrow-right"></i>
            </button>
            <button class="btn-cadastrar" onclick="window.location.href = 'pontoscoletaemp.php'">Pontos de coleta<i class="fas fa-arrow-right"></i>
            </button>
