<?php 
    ...
    if(!isset($_SESSION['id_usuario'])){
        ...
        WHERE statuscoleta = 'Em andamento'";
...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="css/concluircoleta.css">
            ...
            <article class="servico">
                ...
                <div class="inner">
                    <fieldset class="grupo">
                        <h1 class="text-center">Concluir Coleta</h1>
                    </fieldset>
                    <fieldset>
                        <form name="form_buscar" method="post" action="concluircoleta.php">
                    ...
                    <fieldset class="grupo">
                        <form class="form-inline" action="#" method="post">
                            ...
                            <button class="botao"  type="submit" name="submit">Confirmar</button>
                            
                        </form>
                        <!--<button class="botao" onclick="window.location.href = 'cacoleta.php'">Atualizar</button>-->
                    </fieldset>      
                </div>
            </article>
        </main>
<?php
    ...
    if(isset($_POST['numColeta']))
    {
        ...
        if(!empty($numColeta)){
            if($a->concluirColeta($numColeta)){
                echo "<script>alert('Coleta Concluída! Obrigado!');location.href='concluircoleta.php'</script>";
            } 
        }
        else{
            echo "<script>alert('Verifique o numero de coleta informado');location.href='concluircoleta.php';</script>";
        }
    }   
