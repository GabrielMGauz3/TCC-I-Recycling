<?php 
    ...
    if(!isset($_SESSION['id_usuario'])){
        ...
        if(isset($_POST['buscarbtn'])){
            $buscaTermo = addslashes($_POST['buscabox']);;//UTILIZAR ILIKE PARA PESQUISA 
...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="css/cancelarcoletaemp.css">
        ...
        <main class="servicos">
            <article class="servico">
                ...
                <div class="inner">
                    ...
                    <fieldset>
                        <form name="form_buscar" method="post" action="cancelarcoletaemp.php">
...
<?php
    ...
    if(isset($_POST['numColeta']))
    {
        ...
        if(!empty($numColeta)){
            if($a->cancelarColetaEmpresa($numColeta)){
                echo "<script>alert('Coleta Cancelada! Que pena');location.href='cancelarcoletaemp.php'</script>";
            } 
        }
        else{
            echo "<script>alert('Verifique o numero de coleta informado');location.href='cancelarcoletaemp.php';</script>";
        }
    }   
