            ...
            <article class="servico">
                ...
                <div class="inner">
                    <fieldset class="grupo">
                        <h1 class="text-center">Meus Descartes</h1>
                    </fieldset>
                    <fieldset>
                        <form name="form_buscar" method="post" action="meusdescartes.php#">
                    ...
                    <fieldset class="grupo">
                        ...
                        <table style="font-size: small" id="minhatabela" class="table table-bordered" style="width:70%">
                            
                                <tr>
                                        
                                        <!--<th class="success"></thclass>Coleta</th>
                                        <th class="success"></thclass>Data</th>
                                        <th class="success"></thclass>Infomações Adicionais</th>
                                        <th class="success"></thclass>Quantidade</th>
                                        ...
                                        <td><strong>ITEM UM</strong></td>
                                        <td><strong>QUANTIDADE</strong></td>
                                        <td><strong>ITEM DOIS</strong></td>
                                        <td><strong>QUANTIDADE</strong></td>
                            ...
                            <?php
                                ...
                                /*$resultadoConsulta = "SELECT tb_teste_agenda.data_coleta, tb_teste_agenda.periodo,tb_teste_agenda.itemum,tb_teste_agenda.quantidadeum,tb_teste_agenda.itemdois,tb_teste_agenda.quantidadedois,tb_usuarios.nome_usuario,tb_agendamentos.statuscoleta FROM tb_agendamentos
                                INNER JOIN tb_teste_agenda
                                ON tb_agendamentos.id_agendamento = tb_teste_agenda.fk_id_agendamento
                                INNER JOIN tb_usuarios
                                ON tb_agendamentos.fk_id_usuario = tb_usuarios.id_usuario
